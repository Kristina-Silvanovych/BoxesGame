...
namespace Boxes
{
    class GraphicCard : Card
    {
        ...
        private bool opened;
        private readonly string imageShirtPath = Application.StartupPath + @"\images\Back.jpg";
        private readonly string fileName;

        public GraphicCard(CardFigure figure, CardSuit suit, PictureBox pb, bool opened = true) : base(suit, figure)
        {
            Pb = pb;
